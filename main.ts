...
info.onLifeZero(function () {
    game.showLongText("Level:" + ("" + lvl), DialogLayout.Bottom)
    game.gameOver(false)
})
sprites.onOverlap(SpriteKind.atk, SpriteKind.Enemy, function (sprite, otherSprite) {
    sprites.destroy(otherSprite)
    info.changeScoreBy(1)
})
let poulet: Sprite = null
let slash2: Sprite = null
...
game.onUpdate(function () {
    aa = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Text)
    aa.setPosition(122, 25)
    aa.sayText(convertToText(lvl))
})
game.onUpdateInterval(1000, function () {
    ...
    for (let index = 0; index < lvl; index++) {
        if (randint(1, 4) == 1) {
            ...
            ghost.follow(Hero, 70)
            ghost.setPosition(160, randint(0, 120))
        } else if (randint(1, 4) == 3) {
            ghost.follow(Hero, 70)
            ghost.setPosition(randint(0, 160), 0)
        } else {
            ghost.follow(Hero, 70)
            ghost.setPosition(randint(0, 160), 120)
        }
    }
    ...
    Slash.lifespan = 300
    slash2.lifespan = 300
    Slash.setPosition(Hero.x + 10, Hero.y)
    slash2.setPosition(Hero.x - 20, Hero.y)
    if (randint(0, 9) == 0) {
        poulet = sprites.create(img`
            ...
            . . . . . . . . . . . . c c . . 
            `, SpriteKind.Food)
        poulet.setPosition(randint(0, 160), randint(0, 120))
    }
})
